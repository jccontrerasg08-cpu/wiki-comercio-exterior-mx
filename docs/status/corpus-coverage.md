...
Estas señales describen estado editorial/provenance. No equivalen por sí mismas a una conclusión jurídica incorrecta.
...
| `data/corpus/ley-aduanera.md` | `corpus` | `corpus_not_current`, `extraction_incomplete`, `pending_legal_review` |
| `data/corpus/noms-comercio-exterior.md` | `corpus` | `corpus_not_current`, `extraction_incomplete`, `pending_legal_review` |
| `data/corpus/noms-maestro-anexo-241.md` | `corpus` | `extraction_incomplete` |
| `data/corpus/operacion-comex-base.md` | `corpus` | `corpus_not_current`, `extraction_incomplete`, `missing_instrument_reference`, `missing_source_reference`, `pending_legal_review` |
| `data/corpus/reglamento-ley-aduanera.md` | `corpus` | `corpus_not_current`, `extraction_incomplete`, `pending_legal_review` |
