...
Que un tema figure como “cubierto” **no significa** que todas sus páginas estén `reviewed/current`. El estado editorial y legal se consulta en [Estado del corpus](corpus-coverage.md), donde cada promoción depende de evidencia y fecha de revisión.

## Ver también

[Mapa de la wiki](../wiki/index.md) · [Política editorial](../methodology/editorial-policy.md) · [Checklist de revisión](../methodology/page-review-checklist.md)
