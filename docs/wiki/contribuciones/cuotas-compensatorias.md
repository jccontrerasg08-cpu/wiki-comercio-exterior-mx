...
description: Cómo identificar y verificar cuotas compensatorias en México sin confundirlas con la tasa de IGI de la TIGIE.
---
...
1. Clasifica la mercancía con la LIGIE/NICO vigente.
2. Identifica el origen real que deba declararse y la documentación que lo soporte.
3. Consulta el inventario y las resoluciones de la **UPCI/Secretaría de Economía** y las herramientas de SNICE.
4. Abre la resolución aplicable en DOF/SIDOF y verifica su objeto, fracciones, descripción, productor/exportador, cuota y vigencia.
5. Revisa modificaciones, revisiones de vigencia o resoluciones posteriores.
6. Verifica en el Anexo 22 el identificador y complemento que corresponda a la declaración en pedimento.
7. Conserva la evidencia normativa utilizada para la determinación.
...
- [SNICE, cuotas compensatorias](https://www.snice.gob.mx/cs/avi/snice/drrnas.cuotascomp.html)
- [Secretaría de Economía, UPCI](https://www.gob.mx/se/acciones-y-programas/industria-y-comercio-unidad-de-practicas-comerciales-internacionales-upci)
