...
Una operación puede estar simultáneamente sujeta a clasificación arancelaria, impuesto, padrón, permiso, NOM, regla de origen y formalidades de despacho. Cumplir una capa no presume el cumplimiento de las demás.

## Verificación mínima

1. Determina fracción y NICO sin copiar tablas de este repositorio.
