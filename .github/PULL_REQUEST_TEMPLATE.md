...
- Source family or capability:
- `source_id` / `instrument_id`:

## Legal evidence

- Official authority and URL:
- Publication date:
- Effective date and material transitory provisions:
- Page/corpus status and `current_through`:
...
- Impact on `arancel-mx` or existing releases:
- Known gaps, partial coverage, or pending legal review:
